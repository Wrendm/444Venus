            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav justify-content-center">
                        <li class="nav-item"><a class="nav-link" href="/444Venus/admin/admin.php">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="/444Venus/admin/manage-admin.php">Admin</a></li>
